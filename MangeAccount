...
public class MangeAccountActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mange_account);
    ...
    public void update(View view) throws Exception {
        ...
        if (text1.isEmpty() && text2.isEmpty() && text3.isEmpty()){
            Toast.makeText(MangeAccountActivity.this, "Nothing to update", Toast.LENGTH_LONG).show();
            startActivity(new Intent(MangeAccountActivity.this, WelcomeActivity.class));
            finish();
        } else {
            ...
            try {
                ...
                if (text1.isEmpty() && text2.isEmpty()) {
                    ...
                    Toast.makeText(MangeAccountActivity.this, "Account has been updated", Toast.LENGTH_LONG).show();
                    startActivity(new Intent(MangeAccountActivity.this, WelcomeActivity.class));
                    finish();
